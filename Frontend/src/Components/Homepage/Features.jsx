      ...
      <div className="relative z-10 flex size-full flex-col justify-between p-5 text-blue-50">
        ...
        {isComingSoon && (
          <div
            ...
            onMouseLeave={handleMouseLeave}
            className="border-hsla relative flex w-fit cursor-pointer items-center gap-1 cursor-target overflow-hidden rounded-full bg-black px-5 py-2 text-xs uppercase text-white/20"
          >
